...
<body>
    ...
    <form action="/register" method="post" id="signupForm">
         ...
         <div class="mb-3 mr-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput2" name="name" placeholder="Name" pattern="[A-Za-z]+" title="Please enter only letters"  minlength="3" required>
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput4"  name="contact" placeholder="Contact" pattern="[0-9]+" title="Please enter only numbers" maxlength="10" required>
        </div>
